...
SOURCEFILES_QUOTED_IF_SPACED=main.c i2c.c display.c display-i2c.c serial.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/display.p1 ${OBJECTDIR}/display-i2c.p1 ${OBJECTDIR}/serial.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/i2c.p1.d ${OBJECTDIR}/display.p1.d ${OBJECTDIR}/display-i2c.p1.d ${OBJECTDIR}/serial.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/display.p1 ${OBJECTDIR}/display-i2c.p1 ${OBJECTDIR}/serial.p1

# Source Files
SOURCEFILES=main.c i2c.c display.c display-i2c.c serial.c
...
${OBJECTDIR}/display-i2c.p1: display-i2c.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/display-i2c.p1.d 
	@${RM} ${OBJECTDIR}/display-i2c.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/display-i2c.p1  display-i2c.c 
	@-${MV} ${OBJECTDIR}/display-i2c.d ${OBJECTDIR}/display-i2c.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/display-i2c.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
